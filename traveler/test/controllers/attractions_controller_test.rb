...
class AttractionsControllerTest < ActionController::TestCase
  ...
  test "should create attraction" do
    assert_difference('Attraction.count') do
      post :create, attraction: { description: @attraction.description, lat: @attraction.lat, long: @attraction.long, name: @attraction.name }
    end
  ...
  test "should update attraction" do
    patch :update, id: @attraction, attraction: { description: @attraction.description, lat: @attraction.lat, long: @attraction.long, name: @attraction.name }
    assert_redirected_to attraction_path(assigns(:attraction))
  end
